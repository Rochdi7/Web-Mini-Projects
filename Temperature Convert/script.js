...
const celsiusToKelvin = (input) => {
    results.innerHTML = `The final converted value is ${(input + 273.15).toFixed(2)} K`;
};

const celsiusToFahrenheit = (input) => {
    results.innerHTML = `The final converted value is ${(input * (9 / 5) + 32).toFixed(2)} °F`;
};

const fahrenheitToKelvin = (input) => {
    results.innerHTML = `The final converted value is ${((input + 459.67) * (5 / 9)).toFixed(2)} K`;
};

const fahrenheitToCelsius = (input) => {
    results.innerHTML = `The final converted value is ${((input - 32) * (5 / 9)).toFixed(2)} °C`;
};

const KelvinToFahrenheit = (input) => {
    results.innerHTML = `The final converted value is ${(input * 1.8 - 459.67).toFixed(2)} °F`;
};

const KelvinToCelsius = (input) => {
    results.innerHTML = `The final converted value is ${(input - 273.15).toFixed(2)} °C`;
};
